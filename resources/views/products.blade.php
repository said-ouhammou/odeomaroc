            ...
            <div class="flex flex-col justify-center p-6 h-full order-2 lg:order-1">
                ...
                <div>
                    <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                        ...
                        <a href="#" class="w-full sm:w-auto inline-block bg-transparent border-2 border-[#812755] text-[#812755] text-center px-8 py-4 rounded-full text-lg font-bold hover:bg-[#812755] transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#812755] focus:ring-opacity-50">
                            Contactez-nous
                        </a>
                    </div>
                </div>
