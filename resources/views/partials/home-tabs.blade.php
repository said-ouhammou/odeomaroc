        ...
        <div class="swiper my-tabs">
            <nav class="swiper-wrapper py-4 " aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                ...
                <button style="display: flex !important" type="button" class="swiper-slide hs-tab-active:font-semibold hs-tab-active:border-[#812755] hs-tab-active:text-[#812755] py-4 px-8 border-b-2 border-transparent text-lg whitespace-nowrap text-gray-500 flex items-center justify-center gap-1 hover:text-[#812755] focus:outline-none focus:text-[#812755] disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-[#812755]" id="tabs-with-icons-item-2" aria-selected="false" data-hs-tab="#tabs-with-icons-2" aria-controls="tabs-with-icons-2" role="tab">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-milk"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 6h8v-2a1 1 0 0 0 -1 -1h-6a1 1 0 0 0 -1 1v2z" /><path d="M16 6l1.094 1.759a6 6 0 0 1 .906 3.17v8.071a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2v-8.071a6 6 0 0 1 .906 -3.17l1.094 -1.759" /><path d="M12 16m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M10 10h4" /></svg>
                    Snack
                </button>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-restaurant" class=" mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-snack" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            <div class="relative overflow-hidden ">
                                ...
                                <a href="/caisse-enregistreuse-cafe" class="mt-6 font-bold text-[#7f2855] flex items-center">
                                    Découvrir
                                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                    </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-salon-de-the" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-patisserie" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-boulangerie" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-fast-food" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-night-club" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-lounge" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-bar" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                    ...
                    <div class="lg:w-1/2 text-black">
                        ...
                        <p class="text-gray-700 mb-8">
                            Optimisez la gestion de votre bar avec notre solution de caisse enregistreuse Maroc. Conçue spécialement pour les bars, notre caisse tactile facilite la prise de commande, le suivi des ventes et la gestion des stocks. Une solution simple et efficace pour améliorer votre service et maximiser vos profits.t.
                        </p>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/systeme-de-gestion-de-propriete-spa" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/systeme-de-gestion-de-propriete-piscine" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-boutique" class=" mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuse-pressage" class=" mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="#7f2855" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/systeme-de-gestion-de-propriete-hotel" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/systeme-de-gestion-de-propriete-maison-d-hotes" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/systeme-de-gestion-de-propriete-riad" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
