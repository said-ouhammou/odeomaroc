                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreuserestaurant" class=" mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                ...
                <article class="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-8 pb-4">
                    <div class="flex flex-col lg:flex-row gap-12">
                        ...
                        <div class="lg:w-1/2">
                            @php
                                $data = [
                                    'title' => 'Gestion des Commandes avec Caisse Tactile',
                                    'image' => '/images/products/restaurant-commandes.png',
                                    'features' => [
                                        'Prise de commande rapide sur tablette ou caisse tactile',
                                        'Envoi automatique des commandes en cuisine',
                ...
                <article class="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-8 pb-4">
                    <div class="flex flex-col lg:flex-row gap-12">
                        ...
                        <div class="lg:w-1/2">
                            @php
                                $data = [
                                    'title' => 'Gestion des Réservations et Tables',
                                    'image' => '/images/products/restaurant-reservations.png',
                                    'features' => [
                                        'Gestion des réservations en ligne et en temps réel',
                                        'Affichage des tables disponibles et réservées',
                                        'Optimisation du placement des clients selon les disponibilités',
                                        'Suivi des préférences des clients pour un service personnalisé'
                                    ]
                                ];
                            @endphp
                            <h1 class="text-[#4a1d34] text-xl lg:text-3xl font-bold mb-6">
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreusesnack" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="#7f2855" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            <div class="relative overflow-hidden ">
                                ...
                                <a href="/caisse-enregistreusecafe" class="mt-6 font-bold text-[#7f2855] flex items-center">
                                    Découvrir
                                    <svg class="w-4 h-4 ml-2" fill="none" stroke="#7f2855" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                    </svg>
                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="lg:w-1/2  ">
                        <div class="relative ">
                            ...
                            <a href="/caisse-enregistreusesalon-de-the" class="mt-6 text-[#7f2855] font-bold flex items-center">
                                Découvrir
                                <svg class="w-4 h-4 ml-2" fill="none" stroke="#7f2855" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/>
                                </svg>
